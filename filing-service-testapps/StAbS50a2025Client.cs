...
public sealed class StAbS50a2025Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(StAbS50a2025FilingRequest request) =>
        new()
        {
