...
public sealed class Ust2025Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(Ust2025FilingRequest request) =>
        new()
        {
