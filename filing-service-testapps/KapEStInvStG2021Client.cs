...
public sealed class KapEStInvStG2021Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(KapEStInvStG2021FilingRequest request) =>
        new()
        {
