...
public sealed class UenstBe3Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(UenstBe3FilingRequest request) =>
        new()
        {
