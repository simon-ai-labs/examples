...
public sealed class Euer2023Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(Euer2023FilingRequest request) =>
        new()
        {
