...
public sealed class StAbS50a2024Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(StAbS50a2024FilingRequest request) =>
        new()
        {
