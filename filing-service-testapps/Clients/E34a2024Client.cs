...
public sealed class E34a2024Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(E34a2024FilingRequest request) =>
        new()
        {
