...
public sealed class BauStAbErs1Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(BauStAbErs1FilingRequest request) =>
        new()
        {
