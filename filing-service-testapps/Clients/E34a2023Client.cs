...
public sealed class E34a2023Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(E34a2023FilingRequest request) =>
        new()
        {
