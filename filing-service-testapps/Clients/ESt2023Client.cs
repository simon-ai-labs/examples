...
public sealed class ESt2023Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(ESt2023FilingRequest request) =>
        new()
        {
