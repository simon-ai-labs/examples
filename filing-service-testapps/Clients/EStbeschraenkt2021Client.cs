...
public sealed class EStbeschraenkt2021Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(EStbeschraenkt2021FilingRequest request) =>
        new()
        {
