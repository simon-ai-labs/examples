...
public sealed class EStbeschraenkt2023Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(EStbeschraenkt2023FilingRequest request) =>
        new()
        {
