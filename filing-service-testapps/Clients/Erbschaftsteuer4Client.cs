...
public sealed class Erbschaftsteuer4Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(Erbschaftsteuer4FilingRequest request) =>
        new()
        {
