...
public sealed class EStbeschraenkt2024Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(EStbeschraenkt2024FilingRequest request) =>
        new()
        {
