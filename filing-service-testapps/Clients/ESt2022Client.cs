...
public sealed class ESt2022Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(ESt2022FilingRequest request) =>
        new()
        {
