...
public sealed class AntrAnsBesch1Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(AntrAnsBesch1FilingRequest request) =>
        new()
        {
