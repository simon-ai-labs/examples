...
public sealed class Iban1Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(Iban1FilingRequest request) =>
        new()
        {
