...
public sealed class UstVa2020Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(UstVa2020FilingRequest request) =>
        new()
        {
