...
public sealed class LStA2024Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(LStA2024FilingRequest request) =>
        new()
        {
