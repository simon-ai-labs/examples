...
public sealed class KttHh3Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(KttHh3FilingRequest request) =>
        new()
        {
