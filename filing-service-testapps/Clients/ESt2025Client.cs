...
public sealed class ESt2025Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(ESt2025FilingRequest request) =>
        new()
        {
