...
public sealed class StAbS50a2026Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(StAbS50a2026FilingRequest request) =>
        new()
        {
