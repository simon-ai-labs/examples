...
public sealed class EStbeschraenkt2020Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(EStbeschraenkt2020FilingRequest request) =>
        new()
        {
