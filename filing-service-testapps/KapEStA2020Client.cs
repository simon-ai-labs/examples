...
public sealed class KapEStA2020Client(HttpClient httpClient) : FilingApiClientBase(httpClient)
{
    ...
    private static JsonObject CreateFilingPayload(KapEStA2020FilingRequest request) =>
        new()
        {
